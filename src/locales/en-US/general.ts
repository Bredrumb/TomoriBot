...
Repeat: {repeat_text}`,
    ...
    triggered_footer: `Generation kept failing, so the raw reminder was sent instead. This schedule has been removed; re-create it with \`/scheduled-task\` once the problem is fixed.`,
    triggered_footer_recurring: `Generation kept failing, so the raw reminder was sent instead. This recurring schedule has been removed and will NOT repeat; re-create it with \`/scheduled-task\` once the problem is fixed.`,
  },
};
