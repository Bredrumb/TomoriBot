...
`,
    ...
    initialize: {
      ...
      expressions: {
        ...
        partial_success_description: `Analyzed {successful} of {total} expressions. {failed} expression(s) couldn't be processed after several attempts and were skipped — check the bot logs, or try \`/server initialize expressions\` again later.`,
