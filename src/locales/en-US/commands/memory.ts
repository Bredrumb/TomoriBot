  ...
  memory: {
    ...
    history: {
      ...
      import: {
        ...
        debug_description: `DM you the exact per-window prompts as a JSON file (in-character mode only).`,
        debug_dm_title: `In-character Extraction Debug Dump`,
        debug_dm_description: `Per-window prompts captured for **{persona_name}** across **{window_count}** extraction window(s). The attached JSON file contains the full composed system prompt, user prompt, and extracted entries for each window.`,
        debug_dm_failed_title: `Debug Dump Couldn't Be DM'd`,
        debug_dm_failed_description: `I couldn't DM the debug dump — likely because your DMs are closed for this server. Here's the file attached ephemerally instead.`,
