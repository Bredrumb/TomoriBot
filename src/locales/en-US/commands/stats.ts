...
export default {
  stats: {
    ...
    infographic: {
      ...
      persona_title: `Persona Affinity`,
      ...
      through_triggers: `through {count} triggers`,
      persona_share: `{persona} owns {share}% of {user}'s messages`,
      total_memories_owned: `Total Memories Owned`,
      rewards_punishments_made: `Rewards / Punishments Made`,
      favorite_emojis: `Favorite Emojis`,
      favorite_emotions: `Favorite Emotions`,
