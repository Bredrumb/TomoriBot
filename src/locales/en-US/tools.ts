...
export default {
  tools: {
    ...
    image: {
      ...
      notice_default_positive_tags_line: `Default positive image tags are applied.`,
      notice_default_negative_tags_line: `Default negative image tags are applied.`,
      notice_image_tags_tip_line: `Tip: Use \`/persona image-tags\` or \`/personal image-tags\` to save Physical Appearance tags for more consistent characters.`,
      notice_persona_image_tags_detected_line: `Persona image tags detected: {names}.`,
      notice_user_image_tags_detected_line: `User image tags detected: {names}.`,
