export default {
  tools: {
    ...
    user_info_update: {
      ...
      error_missing_persona: `有効なペルソナ系統を特定できませんでした。`,
    ...
    intent_packs: {
      deliberate: {
        image: ["画像", "イラスト", "描いて", "絵を"],
        video: ["動画", "ビデオ", "ムービー"],
        voice: ["音声", "ボイス", "声で", "読み上げ", "しゃべって", "喋って"],
        reminder: [
          "リマインド",
          "リマインダー",
          "タイマー",
        ...
        "cross-channel": ["チャンネルで", "チャンネルに", "別のチャンネル", "スレッドに"],
        search: ["検索", "調べて", "ググ", "最新", "ニュース", "今日の", "現在の", "サイト"],
        memory: ["覚えて", "覚えといて", "忘れないで", "忘れて", "記憶", "メモして"],
        "media-analysis": [
          "この画像",
          "この写真",
          "画像を見",
        ...
        "message-action": ["リアクション", "返信して", "メッセージを削除", "ピン留め", "編集して"],
        "user-blocking": ["ブロック", "ミュート"],
        "user-info": ["呼んで", "呼び方", "ニックネーム", "代名詞", "タイムゾーン"],
        sticker: ["スタンプ", "ステッカー"],
        thread: ["スレッド"],
        capabilities: ["何ができる", "できること", "使えるツール", "どのモデル", "機能を"],
      },
      explicit_memory: [
        "覚えておいて",
        "覚えといて",
