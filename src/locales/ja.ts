    ...
    config: {
      ...
      custom_models: {
        ...
        capability_modal: {
          ...
          workflow_supports_label: `対応ワークフロー`,
          workflow_supports_description: `このComfyUI画像ワークフローで実行できる生成モードを選択してください`,
...
セットアップ手順、Matrix側で使えるコマンド、現在の制限一覧は {help_matrix} を確認してください。`,
      ...
      "fast-regeneration": {
        description: `ユーザー起点の返信に短時間だけ表示される 🔄/➡️ フォローアップリアクションを設定します。`,
        modal_title: `高速フォローアップリアクション`,
        checkbox_label: `有効にするリアクション`,
        checkbox_description: `押せるのはその返信を起動したユーザーだけです。`,
        retry_label: `🔄 再生成`,
        retry_description: `ペルソナのターンを削除して再生成します。`,
        continue_label: `➡️ 続ける`,
        continue_description: `ターンを削除せず、同じペルソナをもう一度起動します。`,
        updated_title: `高速フォローアップリアクションを更新しました`,
        updated_description: `🔄 再生成: **{retry_status}**\n➡️ 続ける: **{continue_status}**`,
        enabled_status: `オン`,
        disabled_status: `オフ`,
      },
      "deliberate-tool-mode": {
