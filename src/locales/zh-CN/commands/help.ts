export default {
  help: {
    ...
    getting_started: {
      ...
      get_api_key: {
        title: `获取 API 密钥`,
        description: `API 密钥让我能访问某个 AI 提供方的模型。\n我生成的所有内容都记在这把密钥上，所以请像\n对待其他密码一样对待它。\n要完成设置，我需要一把：\n> **1.** 在下面选一个提供方，打开它的指南。\n> **2.** 复制它给你的密钥。**不要把它分享**给\n> 任何人，也不要粘贴到频道里，只填进 {setup}\n> 为你打开的输入框。\n> **3.** 运行 {setup}，等我询问时粘贴密钥。`,
        picker_footer: `-# 第二个列表是可选项：Brave Search 增加网页\n-# 结果，ElevenLabs 增加托管语音。两者各有\n-# 独立指南，完成设置都不需要它们。\n-# 如果你的端点不在列表里，可以跳过密钥，\n-# 看本页的 **自定义端点（高级）**。`,
      },
      change_trigger_behavior: {
        title: `调整触发行为`,
        description: `默认情况下，你说我的名字、@我或回复我，我就会回应。你可以按频道\n放宽、收紧或直接关掉。\n\n**我可以在哪里说话**\n你可以让我只在白名单频道里回复。\n在白名单里添加即可，见 {moderationWhitelist}。\n> 不在名单里的频道我保持安静。\n\n**我自己主动开口**\n{configAutoTrigger} 让我可以每隔几条消息，或随机地\n自动发一条消息。\n\n**只用提及触发我**\n明确触发模式让我不再因为叫到名字就回应，\n而是等 @提及。在 {configBehaviorTrigger} 里打开。`,
      },
      create_first_persona: {
        title: `创建你的第一个人格`,
        description: `*人格* 就是换一个名字、头像、性格等等的我，功能完全一样！\n你可以编辑现有的那个，也可以新建。\n\n**改掉现有的那个**\n{configPersonaGeneral} 设置我的名字、性格和称呼别人的\n方式。{configPersonaAppearance} 设置我的头像。\n\n**用一句话写出新人格**\n{personaGenerate} 用一小段描述生成完整人格。\n{personaCreate} 给你一份空白模板。\n\n**从别处带一个进来**\n{personaImport} 接受从 botbooru、chub 等角色卡\n站点下载的角色卡。`,
        footer: `你可以同时保留多个人格。见「功能」里的\n-# **多个人格**。`,
      },
      explore_features: {
        title: `看看我的功能！`,
        description: `设置完成了。现在我能说话了，这些是我能做的事。\n- **使用这个服务器的表情与贴纸**，运行\n  {expressionsInitialize} 之后即可。\n- **欢迎新成员**，在 {configWelcome} 里设置。\n- **记住并提醒**：直接让我提醒你，或者\n  告诉我值得留下的事。\n- **搜索网页**并使用其他工具，在\n  {configTools} 里打开。\n- **生成图像、视频和语音**，用 {generateImage}、\n  {generateVideo} 和 {generateVoice}。\n\n我的大部分开关都在 {config} 里，但不是全部。`,
        footer: `**Brave Search** 会给我已有的搜索加上网页\n-# 结果。它需要单独的密钥，「设置」里的\n-# **获取 API 密钥** 可从可选服务列表打开指南。\n-# 文档站是这块面板的完整版本，\n-# 逐项解释了每个设置。`,
      },
    },
    personal_profile: {
      title: `个人资料`,
      ...
      nickname_pronouns: {
        title: `你的昵称与代词`,
        description: `告诉我该怎么称呼你，我会在任何地方都用这个称呼。\n\n在 {personalProfile} 里设置。\n> 昵称：我用来代替你 Discord 名字的称呼\n> 前缀与后缀：称号或敬称，例如 \`-san\`\n> 代词：\`she/her\`、\`they/them\`、\`any\`，或你的名字\n\n留空的字段会回退到你的 Discord 现用名字，\n以及人格自己的称呼习惯。`,
        footer: `某个人格可以单独用别的称呼叫你。在\n-# 个人资料 > 人格专属偏好 里设置。`,
      },
      personal_memories: {
        title: `个人记忆`,
        description: `我专门记住的关于你的事，在每个服务器都生效。\n\n**直接告诉我就行**\n在聊天里说一句，我会自己存下来。存好时\n会出现一条确认消息。\n\n**或者手动管理**\n{personalMemories} 列出我记住的关于你的一切，\n并允许你编辑或删除其中任意一条。\n\n**决定我能用多少**\n{personalPrivacy} 设置你的隐私等级，从完全\n个性化一直到完全不做个性化。`,
        footer: `这些与这个服务器共享的记忆是分开的，\n-# 后者这里任何人都能查看和编辑。`,
      },
      personal_providers: {
        title: `个人提供方（高级）`,
        description: `在和我说话的任何地方，都用你自己的 API 密钥和模型回复，\n而不是服务器用的那一套。\n\n**保存一个提供方**\n{personalProviders} 会保存你的密钥，并立刻启用你的\n个人文本模型。\n\n**换一个模型**\n{personalModels} 用来切换模型，采样器和\n备用模型就在同一分类的旁边。\n> 你的个人设置只影响你触发的回复。\n> 服务器里的其他人不受影响。\n\n有些服务器要求这样做。如果某个服务器开启了用户 BYOK，\n你不先在这里保存一个提供方，我就无法回复你。`,
      },
    },
    custom_endpoints: {
      title: `自定义端点（高级）`,
      description: `把我指向你自己运行或信任的端点：Ollama、LM Studio、\nLiteLLM、KoboldCPP、ComfyUI，或自部署的语音服务器。\n> {providers} 为整个服务器注册一个。\n> {personalProviders} 只为你自己注册一个。`,
      text_models: {
        title: `文本模型`,
        description: `选择 **添加新的自定义端点**，然后填一个标签、\n基础 URL 和它的 API 风格。需要认证令牌的话也填上。\n\n选中保存好的标签，选择 **+ 添加新文本模型**，\n填入端点要求的准确模型代号。添加模型即启用它。\n> 视觉、工具使用和结构化输出请如实勾选。\n> 我决定给你发什么时会信任这些标记。\n\n之后可以在 {configSwitchModels} 里切换过去。`,
        footer: `完整的 API 风格与兼容性参考在\n-# 文档站上。`,
      },
      comfyui: {
        title: `ComfyUI（用于视频与图像）`,
        description: `先在 ComfyUI 里搭好并测试工作流，再用\n**Save (API Format)** 导出。\n\n把提示词占位符放在提示词该在的位置，\n其他占位符放在你想注入尺寸、时长或\n模型代号的地方。\n\n注册端点时 API 兼容性选 \`ComfyUI\`（例如\n\`http://127.0.0.1:8188\`），再给它添加一个图像或视频\n模型，然后上传导出的 JSON。\n> 图必须以真正的保存节点结尾，只有预览\n> 节点的话我没有文件可下载。`,
        footer: `现成的工作流在 GitHub 仓库里，\n-# 完整的占位符列表在文档站上。`,
      },
      text_to_speech: {
        title: `文本转语音（用于语音）`,
        description: `用同样的方式注册语音端点，然后给每个人格\n配一个声音。\n\n托管服务与自部署服务器都可以，包括\nChatterbox-Turbo、Qwen3-TTS、IrodoriTTS 和 ElevenLabs。\n先注册端点，再给它添加语音模型。\n> 在 {configPersonaVoice} 里指定声音。\n> 在 {configVoices} 里调节语速和默认值。`,
        footer: `你发给我的语音消息会通过同一份端点列表转写，\n-# 设置方式也一样。托管语音方面，\n-# ElevenLabs 在「设置」的 **获取 API 密钥** 里有自己的\n-# 指南，列在可选服务中。`,
      },
    },
    multiple_personas: {
      title: `多个人格`,
      description: `一个服务器里可以有多个人格，各自有\n自己的名字、记忆和目标！`,
      mains_alters_title: `主人格与副人格`,
      mains_alters_body: `主人格是在服务器里代表我的人格。\n副人格是我可以借其说话的第二身份，\n消息上有它自己的名字和头像。`,
      bringing_in_title: `引入人格`,
      bringing_in_body: `{personaImport} 以文件形式接收角色卡：\n> \`.png\` 卡片，来自 TomoriBot 或 SillyTavern\n> \`.json\` 卡片，来自 TomoriBot 或 SillyTavern\n> \`.charx\` 压缩包，Character Card V3\n\n只会读取角色的文字。目前会跳过卡片自带的立绘、\n音频和视频，所以请自己在\n{configPersonaAppearance} 和 {configPersonaSprites} 里设置。`,
      where_to_find_title: `去哪里找角色卡`,
      where_to_find_body: `用 {personaGenerate} 或 {personaCreate} 自己做一个，\n或者去找现成的。\n\nbotbooru、chub 这类角色卡站点上有成千上万张。\n它们是别人的站点，而且为别的 bot 写的卡片\n未必能顺利转换。`,
      talking_title: `让人格之间互相说话`,
      talking_body: `在 {configPersonaTriggers} 里给每个人格单独的触发词和\n频道，它们就会在同一段对话里\n并排回复。`,
      footer: `用 {personaExport} 分享一个你自己的人格。`,
    },
    media_generation: {
      title: `媒体生成`,
      description: `我可以生成图像、视频和语音，既可以用指令，\n也可以由你在对话里要求。\n> 每次生成都计入服务器的配额。见「管理」里的\n> **配额**。`,
      image_generation: {
        title: `图像生成`,
        description: `{generateImage} 会打开提示词输入框。你可以自己写提示词，\n也可以选择 **画出当前场景**，让我来描绘现场。\n> 最多可附三张参考图来引导结果。\n> 在同一个框里选择宽高比。\n\n这里保存的、标注支持图像的提供方或端点都能画图，\n{providers} 会显示你有哪些可用。不能用参考图的会说明，\n然后只按文字来画。`,
        footer: `默认值在 {configImageDefaults} 里。`,
      },
      video_generation: {
        title: `视频生成`,
        description: `{generateVideo} 接收一段提示词，可选地接收频道里\n已有图像作为起始帧。\n\n任何标注支持视频的提供方或端点都能生成，\n包括 ComfyUI 视频工作流。{providers} 会显示\n你有哪些可用。\n> 视频在任何地方都又慢又贵，请做好等待的准备。`,
      },
      speech_generation: {
        title: `语音生成`,
        description: `{generateVoice} 把文字变成当前人格声音的\n语音消息。\n\n必须先注册语音端点，托管或自部署都可以：\n见「设置」里的 **自定义端点（高级）**。\n> 每个人格的声音可以不同。声音来自\n> {configPersonaVoice}。`,
      },
    },
    tons_of_tweakability: {
      ...
      behavior_tuning: {
        title: `行为调校`,
        description: `我怎么写、怎么想，以及被允许做什么。\n> **模型**：{configSwitchModels} 选择实际回答的模型\n> 及其参数\n> **回复自然度**：{configBehaviorGeneral} 控制我的表达有多\n> 像真人，从正式到非常随意。\n> **系统指令**：同样在 {configBehaviorGeneral}，\n> 用于对每条回复都生效的要求。\n> **工具**：{configTools} 决定我可以动用哪些能力，\n> 例如网页搜索或图像生成。`,
        footer: `采样器层面的旋钮（温度之类）在\n-# {configParameters} 里，用来调节随机性等。`,
      },
      server_wide_settings: {
        title: `服务器级设置`,
        description: `对服务器里每个人生效的边界。仅限\n管理员。\n> **我在哪里说话**：白名单频道、每个人格的\n> 频道限制和冷却，都在 {moderation} 里。\n> **我什么时候自己开口**：{configAutoTrigger}。\n> **谁能触发我**：白名单身份组，同样在\n> {moderation} 里。\n> **我的记录放在哪里**：{configWelcome} 设置日志与\n> 欢迎频道。`,
        footer: `频道级覆盖可以让某个频道有自己的\n-# 模型或规则。见 {configChannelOverrides}。`,
      },
      personal_settings: {
        title: `个人设置`,
        description: `你自己的偏好，会悄悄覆盖服务器的设置，\n只影响你触发的回复。\n> **我认为你是谁**：昵称、代词和隐私，\n> 在 {personalProfile} 里。\n> **谁来回答你**：你自己的提供方和模型，在\n> {personalProviders} 里。\n> **我怎么对待你**：回复模式和个人\n> 聚焦，在 {personalConfig} 里。\n\n这里的一切都会跟着你在服务器之间走。`,
        footer: `个人聚焦让某个人格把你当作它的\n-# 关注对象，在 {personalSpotlight} 里设置。`,
      },
    },
    memory_catalog: {
      title: `记忆`,
      description: `我保留两种记忆：长期有效的事实，以及\n正在进行的这段对话的工作记录。`,
      long_term_memory: {
        title: `长期记忆`,
        description: `我永久保留的事实，属于这个服务器或属于你。\n\n**教导我**\n在聊天里说，或者手动添加：服务器记忆用 {memories}，\n你自己的用 {personalMemories}。\n\n**让我忘掉**\n同样是这两条指令，列出所有条目并删除其中任意一条。\n\n**给我文档**\n{memories} 也接受上传的文件。相关部分在需要时\n才会被读出来，不会一次性全读，\n靠的就是检索增强生成（RAG）。\n> 服务器记忆这里所有人都能用。个人记忆\n> 只在你参与对话时才会出现。`,
      },
      short_term_memory: {
        title: `短期记忆`,
        description: `我对这个频道里正在进行的对话的工作记录，\n每个频道单独保存。\n\n我会边走边总结发生了什么，长对话因此\n保持连贯，而不用重发每条消息。\n> **刷新节奏**：我多久更新一次这份记录。\n> **呈现模式**：摘要是替换最近的消息，\n> 还是放在它们旁边。\n> **分类**：最多五个带标签的字段，例如\n> \`Goals\` 或 \`Inventory\`，代替一段自由记录。\n\n管理员可以在 {configAdvancedMemory} 里调整全部设置，\n{memories} 可以清空当前记录。`,
        footer: `让我永久记住某件事，它就会变成\n-# 长期记忆。`,
      },
      rewards_punishments: {
        title: `奖励与惩罚`,
        description: `我确实会注意并记住的有趣指令。对我好一点，\n或者不好，我都会照做反应。\n> {reward}：摸头、拥抱、亲吻、挠痒或喂食。\n> {punish}：敲头、咬、捏、打屁股或捏紧。`,
        footer: `同时有几个人格时，请指明你针对的是哪一个。`,
      },
      memory_tagging: {
        title: `记忆标签（高级）`,
        description: `默认情况下，范围内的每条记忆都会随每条消息一起发送。\n标签可以缩小这个范围。\n> **关键词标签**：带标签的记忆只在其关键词出现在\n> 对话里时才会唤醒。没有标签的记忆\n> 始终有效。\n> **频道标签**：\`#channel\` 标签把记忆限制在那个\n> 频道，并与关键词标签叠加。\n\n在 {configAdvancedMemory} 里把两者打开，然后用\n{toolPromptSnapshot} 查看当前究竟有哪些记忆\n处于有效状态。`,
        footer: `上传的文档和提取出的历史记录也可以带\n-# 频道标签。`,
      },
    },
    scheduled_tasks: {
      title: `定时任务`,
      ...
      making_title: `创建一条`,
      making_body: `直接说就行。「14:30 提醒我起来活动一下」或「每天早上\n发一句站会问题」就够了，我会建好任务，\n并向你确认细节。`,
      changing_title: `修改或取消`,
      changing_body: `{scheduledTaskEdit} 打开任意已有任务：内容、\n下次触发时间、重复间隔，以及是否 @你。\n{scheduledTaskRemove} 删除一条。`,
      who_title: `谁可以动什么`,
      who_body: `你随时可以编辑自己的任务。服务器管理员可以编辑\n任何人的任务，因为任务会发到共享频道。\n> 时间使用设置时指定的时区，所以在依赖\n> 早上 6 点的闹钟之前先核对一下时区。`,
    },
    server_moderation: {
      title: `服务器管理`,
      description: `关于谁能在这里使用我、在哪里使用我的一切。全部\n需要管理服务器权限，都在 {moderation} 里。\n> **成员访问**：谁可以触发我，以及他们能用到\n> 哪些模型。\n> **白名单**：我被允许回复的频道、身份组和\n> 人格。\n> **配额**：这个服务器允许多少生成量。\n> **用户屏蔽名单**：我必须忽略的个别成员。`,
      blacklisting: {
        title: `屏蔽名单`,
        description: `被屏蔽的成员完全无法触发我，在任何频道、\n用任何人格都不行。\n\n在 {moderationBlacklist} 里添加。同一页面会列出\n当前所有条目，并可逐条或批量移除。\n> 屏蔽管的是访问权限，不是删除。关于该成员的\n> 记忆会保留，直到有人删掉。`,
        footer: `如果要让整个频道安静，而不是针对某个人，\n-# 请改为把该频道移出白名单。`,
      },
    },
    quotas: {
      title: `配额`,
      description: `配额限制这里能生成多少，这样就不会有人\n不小心花掉一个月的额度。`,
      spent_title: `用量怎么算`,
      spent_body: `有三个独立的池子：文本、图像和视频。每个池子\n都按成员和整个服务器各算一次，\n先耗尽的那个会中止请求。\n> 被拒绝的请求会告诉你哪个池子用完了，\n> 以及什么时候恢复。`,
      limits_title: `设置上限`,
      limits_body: `{moderationQuotas} 设置每个池子的每日额度。\n不想限制的话，把某个池子留为无限制即可。`,
      starting_over_title: `重置池子`,
      starting_over_body: `{quotaResetUser} 清空某位成员的当日用量，\n{quotaResetGlobal} 清空服务器级池子。两者都需要\n管理服务器权限。`,
      footer: `池子每天会自动重置。手动重置是为了\n-# 不该让某人干等的时候。`,
    },
    age_restricted_commands: {
      title: `年龄限制指令`,
      description: `仅限成年人。打开任何功能之前请先读这一节。`,
      filter_title: `默认不做过滤`,
      filter_body: `我自带的内容不过滤，因为过滤在挡住某些内容的同时，\n同样会拉低普通回复的质量。这里什么合适由\n服务器管理员决定，不是我。\n> 你的 AI 提供方仍会在自己那边执行它的规则，\n> 无论这里怎么设置，它都可能拒绝请求。`,
      gated_title: `明确的成人功能有门槛`,
      gated_body: `明确属于成人的内容都在 {nsfw} 之后，并且只在 Discord\n标记为年龄限制的频道里生效。\n\n{nsfwJailbreaks} 选择这个服务器启用哪些提示词策略。\n管理员没打开之前，它们全部关闭。\n> 这些策略会改变我被提示的方式。它们能让我少拒绝一些，\n> 但也可能带来意外行为。`,
      footer: `启用这些功能即表示服务器管理员确认该频道\n-# 仅限成年人，并为此负责。`,
    },
    user_byok: {
      title: `用户 BYOK（高级）`,
      description: `BYOK 就是自备密钥：每位成员用自己的提供方\n为自己的回复付费。`,
      changes_title: `会改变什么`,
      changes_body: `开启 BYOK 后，只有保存了个人提供方的成员，\n其消息才会被回复。服务器自己的提供方\n不会作为他们的备用。\n> 在 {moderationMemberAccess} 里打开，或在 {setup}\n> 过程中选择。`,
      suits_title: `适合谁`,
      suits_body: `共享一把 API 密钥会被用光的大型或公开服务器。\n小型服务器通常更愿意共用一个提供方。`,
      members_title: `成员需要做什么`,
      members_body: `在 {personalProviders} 里保存密钥。想了解步骤，\n可以让他们看「设置」里的 **个人提供方（高级）**。`,
      footer: `仅限服务器。私信里没有成员可以自备\n-# 密钥，所以那里不提供这个选项。`,
    },
    sillytavern_presets: {
      title: `SillyTavern 预设集`,
      description: `导入一个 SillyTavern 提示词预设集，我就会按那个\n预设集的方式构建提示词。`,
      importing_title: `导入预设集`,
      importing_body: `{configStPresets} 接收导出的预设集 JSON，之后你可以\n启用、停用或移除它。`,
      controls_title: `它控制什么`,
      controls_body: `预设集接管提示词的排序，以及对话周围的\n指令块。\n> 启用后，它会覆盖来自 {configBehaviorGeneral} 的\n> 系统提示词和来自 {configPersonaAdvanced} 的\n> 人格提示词。`,
      still_applies_title: `什么仍然生效`,
      still_applies_body: `人格属性、示例对话、记忆和工具仍会发送。\n预设集决定的是排列方式，不是内容。`,
      footer: `关掉预设集就会回到我自己的提示词布局，\n-# 不会丢失任何内容。`,
    },
    mcp_servers: {
      title: `MCP 服务器`,
      description: `MCP 是把工具交给 AI 的标准方式。接入一个之后，\n它的工具就成了我真正能做的事。`,
      hosted_title: `托管服务器`,
      hosted_body: `{configMcp} 接收一个 URL 和可选的认证令牌。那个服务器\n公开的任何东西都会出现在我的工具列表里。`,
      local_title: `本地服务器`,
      local_body: `跑在你自己机器上的服务器，只要能访问，用法也一样。\n文档站上有步骤说明。`,
      before_title: `接入之前`,
      before_body: `> MCP 服务器的工具会用你给它的权限运行，\n> 只要看起来相关我就会使用它们。请接入你\n> 信任的服务器，并先读清楚它们的工具做什么。`,
      footer: `随时可以在 {configTools} 里单独关掉某个工具。`,
    },
    matrix_bridge: {
      title: `Matrix`,
      description: `我可以同时待在 Matrix 房间和 Discord 频道里，\n把对话在两边传递。`,
      linking_title: `关联房间`,
      linking_body: `{matrixLink} 把当前频道关联到一个 Matrix 房间\nID，形如 \`!abcdef:matrix.org\`。请先邀请\n{matrixBotUser} 进入那个房间。`,
      reads_title: `它怎么读取`,
      reads_body: `两侧的消息会作为同一段对话到达我这里，\n我会在两边都回复。\n> 附件、编辑和表情回应不一定都能带过去。\n> 可靠传递的是文字。`,
      footer: `什么都没关联上？先确认邀请已被接受，\n-# 再检查其他问题。`,
    },
  },
};
