export default {
  memories: {
    ...
    retry: `重试`,
    memories_title: `[服务器记忆](https://docs.tomoribot.app/en/features/knowledge/memory/#personal-vs-server-memories)`,
...
每位成员的记忆。`,
    ...
    documents_title: `[文档](https://docs.tomoribot.app/en/features/knowledge/memory/#document-knowledge-base-rag)`,
