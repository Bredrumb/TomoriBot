...
{failure_list}`,
    ...
    tips: {
      ...
      disable_personal_text_override: `这个请求错误来自你的[个人提供方](https://docs.tomoribot.app/en/features/knowledge/personalization/#your-own-providers)。请在 \`/personal providers\` 里更新它，或者用 \`/personal config\` 选一个能用的模型。`,
...
所选模型要求允许把数据用于付费模型训练，但你 OpenRouter 账户的隐私设置目前不允许。`,
    ...
    self_teach: {
      ...
      server_memory_learned_description: `已保存一则 **[服务器记忆](https://docs.tomoribot.app/en/features/knowledge/memory/#long-term-memory)**：
\`\`\`
{memory_content}
\`\`\``,
      server_memory_updated_title: `📝 {persona_nickname} 更新了一条记忆！`,
      server_memory_updated_description: `已更新一则 **[服务器记忆](https://docs.tomoribot.app/en/features/knowledge/memory/#long-term-memory)**：
\`\`\`
{memory_content}
\`\`\``,
      server_memory_deleted_title: `🗑️ {persona_nickname} 删除了一条记忆！`,
      server_memory_deleted_description: `已删除一则 **[服务器记忆](https://docs.tomoribot.app/en/features/knowledge/memory/#long-term-memory)**：
\`\`\`
{memory_content}
\`\`\``,
      personal_memory_learned_title: `💡 {persona_nickname} 学到了关于 {user_nickname} 的新东西！`,
      personal_memory_learned_description: `已保存一则关于 {user_nickname} 的 **[个人记忆](https://docs.tomoribot.app/en/features/knowledge/memory/#long-term-memory)**：
\`\`\`
{memory_content}
\`\`\``,
      personal_memory_updated_title: `📝 {persona_nickname} 更新了一条关于 {user_nickname} 的记忆！`,
      personal_memory_updated_description: `已更新一则关于 {user_nickname} 的 **[个人记忆](https://docs.tomoribot.app/en/features/knowledge/memory/#long-term-memory)**：
\`\`\`
{memory_content}
\`\`\``,
      personal_memory_deleted_title: `🗑️ {persona_nickname} 删除了一条关于 {user_nickname} 的记忆！`,
      personal_memory_deleted_description: `已删除一则关于 {user_nickname} 的 **[个人记忆](https://docs.tomoribot.app/en/features/knowledge/memory/#long-term-memory)**：
\`\`\`
{memory_content}
\`\`\``,
