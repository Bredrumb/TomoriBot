...
{failure_list}`,
    ...
    tips: {
      ...
      disable_personal_text_override: `Este erro de solicitação veio do seu [provedor pessoal](https://docs.tomoribot.app/en/features/knowledge/personalization/#your-own-providers). Atualize-o em \`/personal providers\` ou selecione um modelo funcional com \`/personal config\`.`,
...
O modelo selecionado requer a permissão de dados para treinamento de modelo pago, mas as configurações de privacidade da sua conta do OpenRouter atualmente bloqueiam isso.`,
    ...
    self_teach: {
      ...
      server_memory_learned_description: `Uma **[Memória do Servidor](https://docs.tomoribot.app/en/features/knowledge/memory/#long-term-memory)** foi salva:
\`\`\`
{memory_content}
\`\`\``,
      server_memory_updated_title: `📝 {persona_nickname} Atualizou uma Memória!`,
      server_memory_updated_description: `Uma **[Memória do Servidor](https://docs.tomoribot.app/en/features/knowledge/memory/#long-term-memory)** foi atualizada:
\`\`\`
{memory_content}
\`\`\``,
      server_memory_deleted_title: `🗑️ {persona_nickname} Apagou uma Memória!`,
      server_memory_deleted_description: `Uma **[Memória do Servidor](https://docs.tomoribot.app/en/features/knowledge/memory/#long-term-memory)** foi apagada:
\`\`\`
{memory_content}
\`\`\``,
      personal_memory_learned_title: `💡 {persona_nickname} Aprendeu Algo Novo sobre {user_nickname}!`,
      personal_memory_learned_description: `Uma **[Memória Pessoal](https://docs.tomoribot.app/en/features/knowledge/memory/#long-term-memory)** sobre {user_nickname} foi salva:
\`\`\`
{memory_content}
\`\`\``,
      personal_memory_updated_title: `📝 {persona_nickname} Atualizou uma Memória sobre {user_nickname}!`,
      personal_memory_updated_description: `Uma **[Memória Pessoal](https://docs.tomoribot.app/en/features/knowledge/memory/#long-term-memory)** sobre {user_nickname} foi atualizada:
\`\`\`
{memory_content}
\`\`\``,
      personal_memory_deleted_title: `🗑️ {persona_nickname} Apagou uma Memória sobre {user_nickname}!`,
      personal_memory_deleted_description: `Uma **[Memória Pessoal](https://docs.tomoribot.app/en/features/knowledge/memory/#long-term-memory)** sobre {user_nickname} foi apagada:
\`\`\`
{memory_content}
\`\`\``,
