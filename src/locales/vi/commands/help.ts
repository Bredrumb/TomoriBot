...
-# chi tiết từng cài đặt.`,
    ...
    mcp_servers: {
      ...
      before_body: `> Công cụ của MCP server chạy với quyền bạn đã cấp cho\n> nó, và mình sẽ dùng khi thấy phù hợp. Hãy kết nối MCP server\n> tin cậy và tìm hiểu kỹ công cụ trước.`,
