  ...
  commands: {
    speech: {
      ...
      transcripts: {
        ...
        enabled_success: `Visible transcript posting is now **enabled**. Voice messages will be transcribed and posted as chat messages via webhook. Background STT for my internal understanding is configured separately with \`/config model transcription\`.`,
...
\`\`\``,
      ...
      image: {
        ...
        generate: {
          ...
          no_model_description: `NovelAI image generation is disabled right now. Select a NovelAI image model with \`/config model image\` first.`,
    ...
    config: {
      ...
      custom_models: {
        ...
        capability_modal: {
          ...
          workflow_supports_label: `Workflow Supports`,
          workflow_supports_description: `Check every generation mode this ComfyUI image workflow can run`,
...
**{selected_count}** channel(s) are currently enabled.`,
      ...
      "user-blacklist": {
        ...
        add: {
          ...
          personalization_disabled_description: `Personalization is currently disabled server-wide. Enable it first with \`/config tools manage\`.`,
...
Use {help_matrix} for setup steps, Matrix-only command notes, and the current limitation list.`,
      ...
      "fast-regeneration": {
        description: `Configure short-lived 🔄/➡️ follow-up reactions for user-triggered replies.`,
        modal_title: `Fast Follow-Up Reactions`,
        checkbox_label: `Enabled reactions`,
        checkbox_description: `Only the user who triggered the reply can press these reactions.`,
        retry_label: `🔄 Regenerate`,
        retry_description: `Delete the persona turn and regenerate it.`,
        continue_label: `➡️ Continue`,
        continue_description: `Trigger the same persona again without deleting the turn.`,
        updated_title: `Fast Follow-Up Reactions Updated`,
        updated_description: `🔄 Regenerate: **{retry_status}**\n➡️ Continue: **{continue_status}**`,
        enabled_status: `On`,
        disabled_status: `Off`,
      },
      "deliberate-tool-mode": {
...
Click **Confirm** to edit it.`,
      ...
      tagging: {
        ...
        set: {
          ...
          channel_select_description: `Enable to allow tagging of memories to a specific #channel. Untagged memories will still work across all channels.`,
...
**Warning:** Personalization is currently disabled on this server, so this change won't affect my behavior here. It will still be reflected on other servers where personalization is enabled.`,
    ...
    generate: {
      image: {
        ...
        disabled_description: `Image generation is disabled on this server. A server member with \`Manage Server\` permissions can enable it using \`/config tools manage\`.`,
...
**Prompt:** {prompt}`,
        ...
        disabled_description: `Video generation is disabled on this server. A server member with \`Manage Server\` permissions can enable it using \`/config tools manage\`.`,
        wrong_provider_title: `🔴 Unsupported Provider`,
...
**Detected Capabilities:** {capabilities}`,
      ...
      fallback: {
        ...
        no_providers_description: `No text providers are configured for this server. Use \`/config provider add\` to set one up first.`,
...
Runtime-ready for the current model: **{runtime_ready_count}**`,
      ...
      override: {
        remove: { description: `Remove a channel or persona model override.` },
    ...
    provider: {
      ...
      "api-key": {
        ...
        set: {
          ...
          novelai_success_with_model_description: `The NovelAI API key has been successfully validated, encrypted, and saved. Your model has been automatically changed to \`{model_name}\`. ⚠️ **Emoji and sticker usage have been automatically disabled** to keep NovelAI's context lean and stable. You can re-enable them anytime with \`/config tools manage\`.`,
