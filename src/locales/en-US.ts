  ...
  commands: {
    speech: {
      ...
      voice_design: {
        ...
        clear_description: `Clear the persona's voice design prompt instead of setting one.`,
        edit_description: `Edit the persona's existing voice design prompt in a prefilled prompt box.`,
        ...
        edit_modal_title: `Edit Voice Design Prompt`,
        ...
        prompt_required_description: `Enter a voice design prompt, or rerun the command with clear enabled.`,
        invalid_combination_description: `Use only one VoiceDesign action at a time: set a prompt, edit the existing prompt, or clear it.`,
        no_existing_prompt_title: `No VoiceDesign Prompt`,
        no_existing_prompt_description: `**{persona}** does not have a VoiceDesign prompt to edit yet. Run \`/speech voice-design\` without edit enabled to create one.`,
