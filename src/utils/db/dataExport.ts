  ...
  try {
    ...
    const configRows = await sql`
			SELECT
				...
				COALESCE(tc_server.deliberate_tool_context_turns, tc_legacy.deliberate_tool_context_turns) as deliberate_tool_context_turns,
				COALESCE(tc_server.deliberate_tool_triggers, tc_legacy.deliberate_tool_triggers, '{}'::jsonb) as deliberate_tool_triggers,
				COALESCE(tc_server.fast_regeneration_enabled, tc_legacy.fast_regeneration_enabled, false) as fast_regeneration_enabled,
				COALESCE(tc_server.fast_regeneration_retry_enabled, tc_legacy.fast_regeneration_retry_enabled, false) as fast_regeneration_retry_enabled,
				COALESCE(tc_server.fast_regeneration_continue_enabled, tc_legacy.fast_regeneration_continue_enabled, false) as fast_regeneration_continue_enabled,
				...
				COALESCE(tc_server.channel_memory_enabled, tc_legacy.channel_memory_enabled, false) as channel_memory_enabled
			FROM tomoris t
    ...
    const exportData: ServerExport = {
      ...
      data: {
        config: {
          ...
          fast_regeneration_enabled: configData.fast_regeneration_enabled,
          fast_regeneration_retry_enabled: configData.fast_regeneration_retry_enabled,
          fast_regeneration_continue_enabled: configData.fast_regeneration_continue_enabled,
