...
This guide takes you from scratch to your first message with TomoriBot. Easiest path is to invite the ready public instance (see the [Privacy Policy](https://github.com/Bredrumb/TomoriBot/blob/main/legal/en-US/privacy-policy.md)). If you'd rather run your own instance, jump to
...
Run `/help api-key` in Discord and pick your provider to see how to get their API key, or
...
- Teach her with `/memory`: see [Memory](/features/knowledge/memory/).
