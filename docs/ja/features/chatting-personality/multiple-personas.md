...
サーバー全体の設定を変更せずに、特定のチャンネルで*あなた*に対してどのペルソナが応答するかを制御したいですか？それがパーソナルスポットライト（Personal Spotlight）です（[パーソナライゼーション](/ja/features/knowledge/personalization/#パーソナルスポットライト)を参照してください）。
