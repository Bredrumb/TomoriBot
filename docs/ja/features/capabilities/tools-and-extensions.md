...
:::note
**明示的ツールモード（Deliberate Tool Mode）**（このセクション）は、*彼女*がどのようにトリガーされるかを制御する**明示的トリガーモード（Deliberate Trigger Mode）**とは無関係です。[チャットとトリガー](/ja/features/chatting-personality/chatting-and-triggers/#明示的トリガーモード)を参照してください。どちらもDiscordでは「DTM」と略されます。
:::
