...
| 07b | Verbatim tool definitions | [`07b-verbatim-tool-definitions.md`](./07b-verbatim-tool-definitions) | `KNOWLEDGE_VERBATIM_TOOL_DEFINITIONS` | `llm.verbatim_tool_calling=false`; provider is not `custom`; model not tool-capable; no tools resolve |
