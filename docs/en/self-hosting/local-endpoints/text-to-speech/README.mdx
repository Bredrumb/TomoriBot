...
For side-by-side empirical latency benchmarks, audio sample playback, and a detailed feature matrix comparing all supported engines, see **[TTS Engine Comparison](/en/self-hosting/local-endpoints/text-to-speech/comparison/)**.
