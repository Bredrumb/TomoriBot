...
- API key: leave empty. The wrapper has no authentication; see [Network access](/self-hosting/local-endpoints/text-to-speech/#network-access).
...
| `FISH_S2_PORT` | `8015` | Fish wrapper port |
