...
Users running on GPUs with constrained VRAM (e.g. 8 GB – 12 GB) who cannot fit the official BF16 checkpoint can opt into the INT8 quantized model (`Imagilux/fishaudio-s2-pro`).
