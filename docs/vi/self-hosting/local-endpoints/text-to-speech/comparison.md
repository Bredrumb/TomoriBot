...
Cột "Clip tham chiếu" cho biết tài liệu của từng engine khuyến nghị hoặc bắt buộc điều gì cho âm thanh tham chiếu sao chép. Đây là hướng dẫn từ thượng nguồn, không phải kết quả đo tại đây, và độc lập với giới hạn tải lên của TomoriBot.
...
|---|---|---|---|---|---|---|
| [Chatterbox](/vi/self-hosting/local-endpoints/text-to-speech/chatterbox/) | 350M Turbo (mặc định), 110M Nano, hoặc 500M Tiêu chuẩn; có, Nano có thể dùng CPU | Tiếng Anh | 10 giây; đoạn dài hơn bị cắt còn 10 s (decoder) và 6 s (encoder) | Sao chép từ tham chiếu, các thẻ sự kiện được hỗ trợ; model tiêu chuẩn cung cấp CFG/độ phóng đại | Tập trung nhanh/gọn; wrapper trả về tệp WAV đầy đủ | Thiết lập sao chép tiếng Anh gọn nhẹ hoặc thử nghiệm trên CPU |
