...
2. Em `/providers`, escolha `Adicionar Novo Endpoint Personalizado` e use a compatibilidade de API `openai-compatible-transcription`.
...
Usuários da ElevenLabs devem escolher `Adicionar Novo Provedor` e **ElevenLabs** em `/providers`; isso registra a transcrição juntamente com a fala.
