...
A coluna "Clipe de referência" informa o que a documentação de cada motor recomenda ou impõe para a referência de clonagem. É orientação upstream, não uma medição feita aqui, e é independente do limite de upload do TomoriBot.
