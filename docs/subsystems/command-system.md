...
- `persona`: create, generate, import, export, default, swap, remove, image-tags, sprites(add/remove), attribute(add/edit/remove), sample-dialogue(add/edit/remove), prompt(set/remove), history(import/remove)
