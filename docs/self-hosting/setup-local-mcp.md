...
[Tools & Extensions](/features/tools-and-extensions/#mcp-servers). **Local** MCP servers are
different:
...
[Tools & Extensions → MCP Servers](/features/tools-and-extensions/#mcp-servers).
