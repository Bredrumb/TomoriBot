...
If your KoboldCPP build exposes that endpoint, register it with `/provider custom-endpoint add` using capability `transcription` and api style `openai-compatible-transcription`.
