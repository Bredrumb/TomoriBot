...
(personality, tone), see [Multiple Personas](/features/multiple-personas/).
...
[Providers & Models](/features/providers-and-models/).
...
[Data Handling](/features/data-handling/) and `/legal privacy`. You can opt out of memory
