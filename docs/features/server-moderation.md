...
[Personalization → Your Own Providers](/features/personalization/#your-own-providers).
...
[Deliberate Tool Mode](/features/tools-and-extensions/#deliberate-tool-mode)).

## Welcome Greetings

`/server welcome` configures an automated greeting for new members in a chosen channel.
Remove it to stop greetings.

## Expressions

`/server expressions initialize` registers your server's custom emojis and stickers so she
uses them accurately — recommended right after setup.
